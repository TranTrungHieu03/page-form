        ...
        return <>
            ...
            <div className={"flex flex-col items-center justify-center h-full w-full "}>
                <div className={"max-w-md"}>
                    ...
                    <h3 className={"text-xl text-muted-foreground border-b pb-10"}>Any one with the link can view and
                        submit
                        the form </h3>
    ...
    return (
        <DndContext sensors={sensors}>
            <main className="flex flex-col w-full">
                <nav className="flex justify-between border-b-2 gap-3 items-center p-2">
